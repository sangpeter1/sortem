...
import { ProfileField } from '@/app/lib/definitions';
...
import { addProfile, ProfilesState } from '@/app/lib/actions';


export default function Form({ profiles }: { profiles: ProfileField[] }) {
  const initialState: ProfilesState = { message: null, errors: {} };
